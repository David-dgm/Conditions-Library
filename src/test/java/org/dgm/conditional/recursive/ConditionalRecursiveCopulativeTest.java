...
class ConditionalRecursiveCopulativeTest {
	...
	void should_return_false_when_recursive_object_to_inspect_is_null_object() {
		...
		final Condition conditionCreated = extractFirstConditionCreated(conditionalRecursive);
	...
	void should_return_false_when_second_level_recursive_object_to_inspect_is_null_object() {
		...
		final ConditionalRecursive<FirstLevelObject> conditionalRecursive = ConditionalRecursive
			.conditionalRecursiveOver(firstLevelObject)
			.isNotNull()
			.andIsNotNull(FirstLevelObject::getSecondLevelObjectInside);
	...
	void should_return_false_when_second_level_recursive_object_to_inspect_is_not_inside() {
		...
		final ConditionalRecursive<FirstLevelObject> conditionalRecursive = ConditionalRecursive
			...
			.isNotNull()
			.andIsNotNull(FirstLevelObject::getSecondLevelObjectInside)
			.andIsNotNull(principalObject -> principalObject.getSecondLevelObjectInside().getThirdLevelObjectInside());
	...
	void should_return_true_when_string_attribute_is_not_empty() {
		...
		final ConditionalRecursive<SecondLevelObject> conditionalRecursive = ConditionalRecursive
			...
			.isNotNull()
			.andIsNotNull(SecondLevelObject::getThirdLevelObjectInside)
			.andIsNotEmptyString(principalObject -> principalObject.getThirdLevelObjectInside().getStringValue());
	...
	void should_return_false_when_string_attribute_is_not_empty() {
		...
		final ConditionalRecursive<SecondLevelObject> conditionalRecursive = ConditionalRecursive
			...
			.isNotNull()
			.andIsNotNull(SecondLevelObject::getThirdLevelObjectInside)
			.andIsEmptyString(principalObject -> principalObject.getThirdLevelObjectInside().getStringValue());
	...
	void should_return_true_when_collection_attribute_is_not_empty() {
		...
		final ConditionalRecursive<SecondLevelObject> conditionalRecursive = ConditionalRecursive
			.conditionalRecursiveOver(secondLevelObject)
			.isNotNull()
			.andIsNotEmptyCollection(principalObject -> principalObject.getThirdLevelObjectInside().getListValue())
			.andIsNotEmptyCollection(principalObject -> principalObject.getThirdLevelObjectInside().getSetValue());
	...
	void should_return_false_when_collection_attribute_is_not_empty() {
		...
		final ConditionalRecursive<SecondLevelObject> conditionalRecursive = ConditionalRecursive
			.conditionalRecursiveOver(secondLevelObject)
			.isNotNull()
			.andIsEmptyCollection(principalObject -> principalObject.getThirdLevelObjectInside().getListValue())
			.andIsEmptyCollection(principalObject -> principalObject.getThirdLevelObjectInside().getSetValue());
	...
	void should_return_true_when_map_attribute_is_not_empty() {
		...
		final ConditionalRecursive<SecondLevelObject> conditionalRecursive = ConditionalRecursive
			...
			.isNotNull()
			.andIsNotNull(SecondLevelObject::getThirdLevelObjectInside)
			.andIsNotEmptyMap(principalObject -> principalObject.getThirdLevelObjectInside().getMapValue());
	...
	void should_return_false_when_map_attribute_is_not_empty() {
		...
		final ConditionalRecursive<SecondLevelObject> conditionalRecursive = ConditionalRecursive
			...
			.isNotNull()
			.andIsNotNull(SecondLevelObject::getThirdLevelObjectInside)
			.andIsEmptyMap(principalObject -> principalObject.getThirdLevelObjectInside().getMapValue());
	...
	void should_return_true_when_number_attribute_is_not_null_and_not_zero() {
		...
		final ConditionalRecursive<SecondLevelObject> conditionalRecursive = ConditionalRecursive
			.conditionalRecursiveOver(secondLevelObject)
			.andIsNonNullAndNotZero(principalObject -> principalObject.getThirdLevelObjectInside().getIntegerValue())
			.andIsNonNullAndNotZero(principalObject -> principalObject.getThirdLevelObjectInside().getLongValue())
			.andIsNonNullAndNotZero(principalObject -> principalObject.getThirdLevelObjectInside().getBigDecimalValue());
	...
	void should_return_false_when_number_attribute_is_not_null_and_not_zero() {
		...
		final ConditionalRecursive<SecondLevelObject> conditionalRecursive = ConditionalRecursive
			.conditionalRecursiveOver(secondLevelObject)
			.andIsNonNullAndIsZero(principalObject -> principalObject.getThirdLevelObjectInside().getIntegerValue())
			.andIsNonNullAndIsZero(principalObject -> principalObject.getThirdLevelObjectInside().getLongValue())
			.andIsNonNullAndIsZero(principalObject -> principalObject.getThirdLevelObjectInside().getBigDecimalValue());
