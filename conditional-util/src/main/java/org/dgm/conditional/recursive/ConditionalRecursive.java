...
import static org.dgm.conditional.recursive.RecursiveConditionFunctions.recursiveConditionFunctions;
...
public class ConditionalRecursive<T> extends Conditional123 {
	...
	private ConditionalRecursive(final T objectToInspect) {
		...
		this.conditionFunctionsProvider = recursiveConditionFunctions();
	}
